 ...
 */
public class SimpleToHXW extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.simple2hxw,container,false);
        return view;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mInputText = (EditText) view.findViewById(R.id.s2h_input_text);
        mTransBtn = (Button) view.findViewById(R.id.s2h_btn);
        mOutputText = (TextView) view.findViewById(R.id.s2h_output_text);
